================================================================================
    БИБЛИОТЕКА MICROSOFT FOUNDATION CLASS. Обзор проекта MFCApplication1
===============================================================================

Это приложение MFCApplication1 автоматически создано с помощью мастера приложений. Это приложение демонстрирует основные принципы использования классов Microsoft Foundation; оно также может использоваться в качестве основы для написания собственных приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения MFCApplication1.
...
MFCApplication1.h
    ...
    Он содержит прочие заголовки, относящиеся к проекту (включая Resource.h), а также объявляет класс приложения CMFCApplication1App.

MFCApplication1.cpp
    Это основной исходный файл приложения, в котором содержится класс приложения CMFCApplication1App.
...
res\MFCApplication1.ico
    Файл значка, используемый в качестве значка приложения. Этот значок включен с помощью основного файла ресурсов MFCApplication1.rc.
...
res\Toolbar.bmp
    ...
    Начальная панель инструментов и строка состояния, созданные в классе CMainFrame. Измените этот точечный рисунок панели инструментов в редакторе ресурсов и обновите массив IDR_MAINFRAME TOOLBAR в файле MFCApplication1.rc, чтобы добавить кнопки панели инструментов.
/////////////////////////////////////////////////////////////////////////////

Мастер приложений создает один тип документов и одно представление:

MFCApplication1Doc.h, MFCApplication1Doc.cpp — документ
    Эти файлы содержат класс CMFCApplication1Doc. Измените эти файлы, чтобы добавить особые данные документа и реализовать сохранение и загрузку файлов (посредством CMFCApplication1Doc::Serialize).
    Документ будет содержать следующие строки:
        Расширение файла:      interp
        Идентификатор типа файла:        MFCApplication1.Document
        Заголовок главного фрейма:  MFCApplication1
        Имя типа документа:       MFCApplication1
        Имя фильтра:         MFCApplication1 Files (*.interp)
        Новое краткое имя файла: MFCApplication1
        Полное имя типа файла: MFCApplication1.Document

MFCApplication1View.h, MFCApplication1View.cpp — представление документа
    Эти файлы содержат класс CMFCApplication1View.
    Объекты CMFCApplication1View используются для просмотра объектов CMFCApplication1Doc.
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем MFCApplication1.pch и файла предкомпилированных типов с именем StdAfx.obj.
